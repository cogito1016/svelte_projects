...
<header>
	...
	<nav>
		...
		<ul>
			...
			<li aria-current={$page.url.pathname === '/icecream-selector' ? 'page' : undefined}>
				<a href="/icecream-selector">Icecrea-Selector</a>
			</li>
			...
			<li aria-current={$page.url.pathname === '/coffee-shop' ? 'page' : undefined}>
